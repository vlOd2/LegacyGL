...
namespace LegacyGL.Internal.Win32Impl.Native
{
    internal static class W32Windowing
    {
        ...
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool PeekMessageA(ref MSG lpMsg, nint hWnd,
        ...
        [DllImport("user32.dll")]
        public static extern int GetWindowTextA(nint hWnd,
            [MarshalAs(UnmanagedType.LPStr)] StringBuilder lpString, int nMaxCount);

        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SetWindowTextA(nint hWnd,
